    ...
    with mp_pose.Pose(min_detection_confidence=0.8, min_tracking_confidence=0.8) as pose:
        ...
        while cap.isOpened():
            ...
            try:
                ...
                cv2.circle(image, (right_elbow_x, right_elbow_y), 15, (255, 255, 0), 6)
                ...
                ##########################################################
                right_shoulder_angle = int(calculate_angle(right_hib, right_shoulder, right_elbow))
                ...
                if default_value == 'auto':
                    ...
                    if right_shoulder_angle > 90:
                        cv2.putText(image, 'Right Shoulder Adduction',
                    ...
                    gotten_angles.append(right_shoulder_angle)

                    if right_shoulder_angle < 90:
                        cv2.putText(image, 'Right Shoulder Abduction',
                                    (0, 150),
                    ...
                    if right_shoulder_angle > stop_value:
                        cv2.putText(image, 'Right Shoulder Adduction',
                                    (0, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 5, cv2.LINE_AA
                                    )
                ...
                cv2.putText(image, f'Right Shoulder Angle : {right_shoulder_angle}', (0, 200), cv2.FONT_HERSHEY_DUPLEX, 1,
                            (0, 255, 255), 4)
                ...
                cv2.putText(image, 'RIGHT SHOULDER DETECTION ', (500, 100),
        ...
        with open(f'static2/right_shoulder_angel@{file_id}.txt', 'w') as file:
