    ...
    with mp_pose.Pose(min_detection_confidence=0.8, min_tracking_confidence=0.8) as pose:
        ...
        while cap.isOpened():
            ...
            try:
                ...
                right_hib = [landmarks[mp_pose.PoseLandmark.RIGHT_HIP].x,
                ...
                cv2.line(image, (right_shoulder_x, right_shoulder_y), (right_hib_x, right_hib_y), (0, 0, 255), 4)
                cv2.line(image, (right_hib_x, right_hib_y), (right_knee_x, right_knee_y), (0, 0, 255), 4)
                #########################################################

                right_hip_angle = int(calculate_angle(right_shoulder, right_hib, right_knee))
                ...
                if default_value == 'auto':
                    ...
                    if right_hip_angle > 90:
                        cv2.putText(image, 'Right Hip Flexion',
                    ...
                    gotten_angles.append(right_hip_angle)
                    if  right_hip_angle < 90:
                        cv2.putText(image, 'Right Hip Extension',
                                    (0, 150),
                ...
                cv2.putText(image, f'Right Hip Angle : {right_hip_angle}', (0, 200), cv2.FONT_HERSHEY_DUPLEX, 1,
                            (0, 255, 255), 5)
                ...
                cv2.putText(image, 'RIGHT HIP DETECTION ', (500, 100),
        ...
        with open(f'static2/right_hip_angel@{file_id}.txt', 'w') as file:
